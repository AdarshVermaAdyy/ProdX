...
export class RiderInformationComponent implements OnInit {
  ...
  fieldsList: InputField[] = [
    ...
    {label: "Rider Option ", formControlName: 'riderOption', type: 'text', isVisible: false,  isMandatory: false,category: 'basicInformation',defaultVal:'Mandatory'},
    {label: "Rider Type", formControlName: 'riderTpye', type: 'text', isVisible: false, isMandatory: false, category: 'basicInformation',defaultVal:'active'},
    {label: "Rider Coverage Amount", formControlName: 'riderCoverAmount', type: 'text', isVisible: false,  isMandatory: false,category: 'basicInformation',defaultVal:'2000'},
    {label: "Rider Term", formControlName: 'riderTerm', type: 'text', isVisible: false, isMandatory: false, category: 'basicInformation',defaultVal:'50,000'},
    {label: "Rider Effective Date", formControlName: 'riderEffectiveDate', type: 'text', isVisible: false,  isMandatory: false,category: 'basicInformation',defaultVal:'9/5/2024'},
    {label: "Rider Expiry Date", formControlName: 'riderExpiryDate', type: 'text', isVisible: false, isMandatory: false, category: 'basicInformation',defaultVal:'9/15/2024'},
    {label: "Rider Premium", formControlName: 'riderPremium', type: 'text', isVisible: false, isMandatory: false, category: 'basicInformation',defaultVal:'12721'},
    {label: "Rider Wait Period", formControlName: 'riderWaitPeriod', type: 'text', isVisible: false, isMandatory: false, category: 'basicInformation',defaultVal:'active'},
    {label: "Rider Renewal Option", formControlName: 'riderRenewal', type: 'text', isVisible: false,  isMandatory: false,category: 'basicInformation',defaultVal:'yes'},
    {label: "Rider Conversion Option", formControlName: 'ridersCoverOption', type: 'text', isVisible: false, isMandatory: false, category: 'basicInformation',defaultVal:'yes'},
    {label: "Rider Condition", formControlName: 'riderCondition', type: 'text', isVisible: false, isMandatory: false, category: 'basicInformation',defaultVal:'Covers spouse only if they are listed as a beneficiary on the policy.'},
    {label: "Min Age", formControlName: 'min', type: 'text', isVisible: false,  isMandatory: false,category: 'basicInformation',defaultVal:'18'},
    {label: "Max Age", formControlName: 'max', type: 'text', isVisible: false,  isMandatory: false,category: 'basicInformation',defaultVal:'80'},
    {label: "Rider Benefits", formControlName: 'rider_benefits', type: 'text', isVisible: false, isMandatory: false, category: 'basicInformation',defaultVal:'Provides an additional coverage amount equal to the sum assured of the base policy in case of accidental death of the spouse.'},
    {label: "Rider Limitation", formControlName: 'rider_limitation', type: 'text', isVisible: false,  isMandatory: false,category: 'basicInformation',defaultVal:'Excludes coverage for pre-existing medical conditions of the spouse.'},
    {label: "Rider Cancellation Term", formControlName: 'rider_cancellation_term', type: 'text', isVisible: false,  isMandatory: false,category: 'basicInformation',defaultVal:'Can be canceled within 30 days of purchase without penalty; after 30 days, cancellation is subject to a 10% penalty'},

    {label: "Rider Age Restriction", formControlName: 'rider_age_res', type: 'text', isVisible: false,  isMandatory: false,category: 'Rider Coverage Info',defaultVal:'No'},
    {label: "Rider Coverage Trigger", formControlName: 'rider_cover_trigger', type: 'text', isVisible: false,  isMandatory: false,category: 'Rider Coverage Info',defaultVal:'No'},
    {label: "Rider Coverage Reductions", formControlName: 'rider_cover_red', type: 'text', isVisible: false, isMandatory: false, category: 'Rider Coverage Info',defaultVal:'87283'},
    {label: "Rider Payment Frequency", formControlName: 'rider_payout_freq', type: 'text', isVisible: false,  isMandatory: false,category: 'Rider Payout Frequency',defaultVal:'Monthly'},
    {label: "Rider Premium Waiver Clause", formControlName: 'rider_prem_waiver', type: 'text', isVisible: false,  isMandatory: false,category: 'Rider Payout Frequency',defaultVal:'2342'},
    {label: "Rider Automatic Increase", formControlName: 'rider_auto_inc', type: 'text', isVisible: false, isMandatory: false, category: 'Rider Payout Frequency',defaultVal:'12721'},
    {label: "Rider Settlement Options", formControlName: 'rider_settle_option', type: 'text', isVisible: false, isMandatory: false, category: 'Rider Payout Frequency',defaultVal:'8272'},
    {label: "Rider Contribution Type", formControlName: 'rider_contri_type', type: 'text', isVisible: false,  isMandatory: false,category: 'Rider Payout Frequency',defaultVal:'12721'},
  ]
  ...
  addRemoveControls(event: any, field: InputField,action = 'function', index?){
    ...
    if(event){
      this.riderDetailsForm.addControl(field.formControlName, new FormControl( field.defaultVal || '',field.isMandatory ? Validators.required : []));
      if(action === 'checkbox'){
  ...
  selectUnselectGroup(event, category){
    const relFields = this.fieldsList.filter(item => item.category === category);
    if(event.checked){
